...
class Addition {
	...
	friend Addition operator + (Addition A, Addition B);
	void showResult();
};
...
//friend function can access private/protected data outside the scope 
//Demonstrated here
Addition operator + (Addition A, Addition B)
{
	Addition X;

	X.a  = A.a + B.a; 
	X.b  = A.b + B.b;
	X.result = A.result + B.result;
